...
const AddQuestion = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(error.response?.data?.message || "Question add failed");
    }
  };

  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold text-gray-800">Add MCQ Question</h1>

      <p className="text-gray-500 mt-2">Create questions for your exam</p>
