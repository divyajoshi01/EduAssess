...
const CreateExam = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // CHECK CREATED EXAM RESPONSE
      console.log("CREATED EXAM:", res.data);
  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <p className="text-gray-500 mt-2">Add exam details for students</p>
      ...
      <div className="bg-white mt-8 p-8 rounded-xl shadow-md max-w-2xl">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            <h2 className="font-bold text-lg mb-3">Select Questions</h2>

            {questions.map((item) => (
              <div key={item._id} className="border p-3 rounded-lg mb-3">
