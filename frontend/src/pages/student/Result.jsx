...
const Result = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <p className="text-gray-500 mt-2">Check your exam performance</p>
      ...
      <div className="grid md:grid-cols-4 gap-6 mt-8">
        {cards.map((card, index) => (
          ...
          >
            ...
            <div className="text-blue-600 text-4xl">{card.icon}</div>
          </div>
        ))}
      </div>
      ...
      <div className="bg-white mt-10 p-8 rounded-xl shadow-md max-w-xl">
        ...
        <div className="mt-5 space-y-3">
          <p>
            Attempted Questions:
            <b className="ml-2">{resultData.attempted}</b>
          </p>

          <p>
            Unattempted Questions:
            <b className="ml-2">{resultData.unattempted}</b>
          </p>

          <p>
            Final Score:
            <b className="ml-2 text-blue-600">{resultData.score}</b>
          </p>
        </div>
      </div>
    </div>
